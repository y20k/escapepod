...
object Keys {
    ...
    // keys
    val KEY_DOWNLOAD_WORK_REQUEST: String = "DOWNLOAD_WORK_REQUEST"
    val KEY_LAST_UPDATE_COLLECTION: String = "LAST_UPDATE_COLLECTION"
    val KEY_NEW_PODCAST_URL: String = "NEW_PODCAST_URL"
    val KEY_RESULT_NEW_COLLECTION = "RESULT_NEW_COLLECTION"

    // requests
    val REQUEST_UPDATE_COLLECTION: Int = 1
    val REQUEST_ADD_PODCAST: Int = 2


    // unique names
    val NAME_PERIODIC_COLLECTION_UPDATE_WORK: String = "PERIODIC_COLLECTION_UPDATE_WORK"
    val NAME_ONE_TIME_COLLECTION_UPDATE_WORK: String = "ONE_TIME_COLLECTION_UPDATE_WORK"
